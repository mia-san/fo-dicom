...
namespace Dicom.Imaging.Codec
{
    ...
    /// 
    /// </summary>
    class Jpeg8_Linux_X86 : ILibIjg
    {
        /// <summary>
        /// logger
        /// </summary>
        /// <returns></returns>
        static readonly Logger logger = LogManager.GetLogger(typeof(Jpeg8_Linux_X86).Name);


        /// <summary>
        /// 
        /// </summary>
        public const string LibraryPath = "linux-x86/libijg8";
